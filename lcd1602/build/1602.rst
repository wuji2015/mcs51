      ...
      000000 02 00 29         [24]  324 	ljmp	__sdcc_gsinit_startup
      000003 32               [24]  325 	reti
      000004                        326 	.ds	7
      00000B 32               [24]  327 	reti
      00000C                        328 	.ds	7
      000013 32               [24]  329 	reti
      000014                        330 	.ds	7
      00001B 32               [24]  331 	reti
      00001C                        332 	.ds	7
      000023 02 02 11         [24]  333 	ljmp	_serial_interrupt_handler
                                    334 ;--------------------------------------------------------
      ...
      000082 02 00 26         [24]  348 	ljmp	__sdcc_program_startup
                                    349 ;--------------------------------------------------------
                                    350 ; Home
                                    351 ;--------------------------------------------------------
                                    352 	.area HOME    (CODE)
                                    353 	.area HOME    (CODE)
      000026                        354 __sdcc_program_startup:
      000026 02 00 85         [24]  355 	ljmp	_main
      ...
      000085                        368 _main:
                           ...
                           000001   375 	ar1 = 0x01
                           000000   376 	ar0 = 0x00
                                    377 ;	1602.c:5: return 0;
      000085 90 00 00         [24]  378 	mov	dptr,#0x0000
      000088 22               [24]  379 	ret
                                    380 	.area CSEG    (CODE)
                                    381 	.area CONST   (CODE)
                                    382 	.area XINIT   (CODE)
